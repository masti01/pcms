...
class BasicBot(
    ...
    def mainheader(self):
        ...
        header +=u'		</table>\n'
        header +=u'		<p>Strona przedstawia statystyki blokad. Podsumowanie jest generowane na podstawie danych z ostatnich ' + self.getOption('days') + u' dni. Strona jest aktualizowana co godzinę.</p>\n'
        # add creation time
