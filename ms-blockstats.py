...
Call: time python masti/ms-blockstats.py -page:'!' -outpage:'block.html' ; cp ~/pw/compat/masti/html/block.html ~/public_html/block.html
...
class BasicBot(
    ...
    def mainheader(self):
        ...
        header +=u'		</table>\n'
        header +=u'		<p>Strona przedstawia statystyki blokad. Podsumowanie jest generowane na podstawie danych z ostatnich ' + self.getOption('days') + u' dni. Strona jest aktualizowana co pięć minut.</p>\n'
        # add creation time
