...
'uk':{ 'Албанія':'Albania', 'Австрія':'Austria', 'Азербайджан':'Azerbaijan', 'Башкортостан':'Bashkortostan', 'Білорусь':'Belarus', 'Болгарія':'Bulgaria', 'Вірменія':'Armenia', 'Боснія':'Bosnia and Herzegovina', 'Боснія і Герцеговина':'Bosnia and Herzegovina', 'Боснія та Герцеговина':'Bosnia and Herzegovina', 'Ерзя':'Erzia', 'Есперантида':'Esperanto', 'Есперанто':'Esperanto', 'есперанто':'Esperanto', 'Естонія':'Estonia', 'Грузія':'Georgia', 'Чехія':'Czechia', 'Хорватія':'Croatia', 'Косово':'Kosovo', 'Кримські Татари':'Crimean Tatars', 'Кримські татари':'Crimean Tatars', 'Литва':'Lithuania', 'Латвія':'Latvia', 'Угорщина':'Hungary', 'Македонія':'North Macedonia', 'Північна Македонія':'North Macedonia', 'Румунія, Молдова':'Romania and Moldova', 'Молдова':'Romania and Moldova', 'Чорногорія':'Montenegro', 'Польща':'Poland', 'Російська Федерація':'Russia', 'Росія':'Russia', 'Румунія':'Romania and Moldova', 'Румунія і Молдова':'Romania and Moldova', 'Республіка Сербська':'Republic of Srpska', 'Сербія':'Serbia', 'Словаччина':'Slovakia', 'Словенія':'Slovenia', 'Туреччина':'Turkey', 'Туречинна':'Turkey', 'Україна':'Ukraine', 'Греція':'Greece', 'Казахстан':'Kazakhstan', },
