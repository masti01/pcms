...
ignorelist = [
    ...
    re.compile('.*[\./@]www\.uj\.edu\.pl/documents/10172/24c02901-aecc-4d79-b067-6ab2fa71fb00'),  # bot rejected on site  (masti)
    ...
    re.compile('.*[\./@]www\.muzeumsg\.pl/images/Publikacje_1918_1939/70\.J\.Prochwicz\.pdf(/.*)?'),  # false postive  (masti)
    ...
    re.compile('.*[\./@]www\.ibdb\.com(/.*)?'), #site automatically redirectong (masti)
    re.compile('.*[\./@]www\.ft\.dk/Folketinget/findMedlem(/.*)?'), # bot rejected on site  (masti)
    ...
    re.compile('.*[\./@]monitorpolski\.gov\.pl/M1950052058801.pdf'),  # bot rejected on site (masti)
    re.compile('.*[\./@]monitorpolski\.gov\.pl/MP/1946/s/26/43'),  # bot rejected on site (masti)
    re.compile('.*[\./@]monitorpolski\.gov\.pl/MP/1947/s/74/490'),  # bot rejected on site (masti)
    re.compile('.*[\./@]monitorpolski\.gov\.pl/MP/1947/s/79/528'),  # bot rejected on site (masti)
    re.compile('.*[\./@]monitorpolski\.gov\.pl/MP/1951/s/66/860'),  # bot rejected on site (masti)
    re.compile('.*[\./@]monitorpolski\.gov\.pl/mp/1949/s/44/592'),  # bot rejected on site (masti)
    ...
    re.compile('.*[\./@]www\.kulanu-party\.co\.il/'),  # bot rejected on site (masti, szoltys)
    ...
    re.compile('.*[\./@]www\.pcworld\.com/article/253200/googles_project_glass_teases_augmented_reality_glasses\.html'),  # bot rejected on site (masti, szoltys)
    re.compile('.*[\./@]\.ceausescu\.org/ceausescu_texts/revolution/trial-eng\.htm'),  # bot rejected on site (masti, szoltys)
    re.compile('.*[\./@]www\.netcarshow\.com/volkswagen/2018-tiguan_allspace/'),  # bot rejected on site (masti, szoltys)
    re.compile('.*[\./@]www\.netcarshow\.com/ford/2017-fiesta/'),  # bot rejected on site (masti, szoltys)
    re.compile('.*[\./@]www\.netcarshow\.com/opel/2018-crossland_x/'),  # bot rejected on site (masti, szoltys)
    ...
    re.compile('.*[\./@]www\.maltauncovered\.com/valletta-capital-city/'),  # bot rejected on site (masti, szoltys)
    ...
    re.compile('.*[\./@]pbn\.nauka\.gov\.pl/sedno-webapp/search?searchCategory=WORK&filter\.globalKey=tomasz%20bajerowski&search\.x=44&search\.y=12&filter\.title&filter\.inJournal&filter\.inBook&filter\.contributor&filter\.contributorRole&filter\.publicationYearFrom&filter\.publicationYearTo&filter\.workType&filter\.affInstitution&sortField=RELEVANCE&sortAscending=true&pageSize=PAGE_SIZE_10'),  # bot rejected on site (masti, szoltys)
    re.compile('.*[\./@]\.songfacts\.com/detail\.php?id='),  # bot rejected on site (masti, szoltys)
    re.compile('.*[\./@]www\.lincolnshire\.org/lincolnshire-sausage/'),  # bot rejected on site (masti, szoltys)
# gcatholic.org
    ...
    re.compile('.*[\./@]gcatholic\.org/dioceses/diocese/zjos7\.htm#57002'),  # bot rejected on site (masti, szoltys)
...
# Ze słownikiem Kopalińskiego podobna sytuacja jak z Gcatholikiem, tzn\. część linków zgłoszona prawidłowo, część nieprawidłowo\. Nieprawidłowe zgłoszenia to:
    ...
    re.compile('.*[\./@]www\.mojamongolia\.com/moj-zyciorys'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]zgryglas\.pl/o-mnie'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]uniwersytetradom\.pl/art/display_article\.php?id=1178'),  # bot rejected on site (masti, Elfhelm)
    ...
    re.compile('.*[\./@]www\.zbigniewkonwinski\.pl'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.terzobinario\.it/elezioni-alessandro-battilocchio-eletto-alla-camera/131593'),  # bot rejected on site (masti, Elfhelm)
    ...
    re.compile('.*[\./@]www\.forumakademickie\.pl/fa/2015/06/jak-stracic-prestiz'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.tubawyszkowa\.pl/aktualnosci/czytaj/4863/Kandydaci-KWW-Kukiz-15-pod-szczesliwa-siodemka'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.kulturalna\.warszawa\.pl/nagroda-literacka,1,10564\.html?locale=pl_PL'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.newyorktheatreguide\.com/news/jl09/bacchae555183\.htm'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.fiedler\.pl/sub,pl,arkady-radoslaw-fiedler\.html'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.fiedler\.pl'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.uniaeuropejska\.org/nominacje-do-nagrod-mep-awards'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.kedzierzynkozle\.pl/portal/index\.php?t=200&id=35673'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.wrp\.pl/prof-dr-hab-eberhard-makosz-1932-2018'),  # bot rejected on site (masti, Elfhelm)
    ...
    re.compile('.*[\./@]www\.bielecki\.pl'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.frithjof-schmidt\.de'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.odg\.mi\.it/node/30222'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.businesseurope\.eu/history-organisation'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]sledzinska-katarasinska\.pl/o-mnie'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.ireneuszras\.pl'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.forumakademickie\.pl/fa/2014/04/kurczewscy'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]wielkopolanie\.zhr\.pl/rozkazy/L4_2010\.pdf'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.jacektomczak\.pl'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.jadwigarotnicka\.pl'),  # bot rejected on site (masti, Elfhelm)
    ...
    re.compile('.*[\./@]www\.faktyoswiecim\.pl/fakty/aktualnosci/15778-oswiecim-to-pewne-janusz-chwierut-wygral-w-pierwszej-turze'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.jerzymaslowski\.pl'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.jerzymaslowski\.pl/wp-content/uploads/2009/02/jmm5\.jpg'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.prowincja\.com\.pl/autorzy/Jerzy-Wcisla,25'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]jerzymalecki\.pl'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www\.mfa\.gov\.pl/pl/aktualnosci/wiadomosci/nominacje_dla_nowych_ambasadorow_rp'),  # bot rejected on site (masti, Elfhelm)
    ...
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/conference/'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/romancuria/'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/nunciature/nunc017\.htm#18000'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.nba-allstar\.com/legends/rosters\.htm '),  # bot rejected on site (masti, Szoltys)
    ...
    re.compile('.*[\./@]www\.gcatholic\.org/churches/'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/diocese/'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/hierarchy/data/card'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former//t1946\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/bagn0\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/iles0\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/micr0\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t3398\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t3383\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t3381\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t2075\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t2065\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t2063\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t2022\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1987\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1984\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1981\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1980\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1979\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1978\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1977\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1976\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1975\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1974\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1971\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1970\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1969\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1967\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1966\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1965\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1964\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1962\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1960\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1959\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1958\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1957\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1956\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1952\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1951\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1949\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1947\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1945\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1943\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1941\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1940\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1938\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1937\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1936\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1935\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1934\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1931\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1928\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1926\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1923\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1911\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1910\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1908\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1907\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1906\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1905\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1904\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1903\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1902\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1901\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1900\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1897\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1896\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1895\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t1893\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t0036\.htm'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]www\.gcatholic\.org/dioceses/former/t
),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.ebelchatow.pl/content/nie-plus-plus-polska-razem'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.bipraciborz.pl/bip/dokumenty-akcja-wyszukaj-idkategorii-39906'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.leggiperme.it/?p=495'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]uniaeuropejska.org/antysemickie-hasa-w-wgierskim-parlamencie/'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.matica.hr/knjige/autor/369/'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.segodnya.ua/politics/pnews/olga-bogomolec-sobiraetsya-ballotirovatsya-v-prezidenty-ukrainy-505598.html'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.federnuoto.it/federazione/federazione-news/item/40079-barelli-eletto-alla-camera.html'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.independent.co.uk/news/world/europe/mariano-rajoy-latest-spain-election-pedro-sanchez-premier-basque-national-party-a8378101.html'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.independent.co.uk/opinion/commentators/denis-macshane-britain-can-help-to-shape-a-new-europe-481214.html'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.pip.gov.pl/pl/wiadomosci/69784,roman-giedrojc-glownym-inspektorem-pracy.html'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.forumakademickie.pl/aktualnosci/2011/1/5/765/jak-ck-wybierano/'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.forumakademickie.pl/fa/2015/07-08/kronika-wydarzen/odzew-w-sprawie-bez-odzewu/'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.independent.co.uk/news/world/europe/mariano-rajoy-latest-spain-election-pedro-sanchez-premier-basque-national-party-a8378101.html'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.wloclawek.info.pl/nowosci,wiadomosci_wloclawek_i_region,1,1,tadeusz_dubicki_nowym_rektorem_p,16036.html'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.pism.pl/publications/bulletin/no-55-905'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]glencteresa.pl/'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.europeanvoice.com/folder/theswedishpresidencyoftheeu/124.aspx?artid=65305'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.mojabibliotekamazurska.pl/biblioteka/ukazaly_sie_02_03.html'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.ordynacka.pl/2017/04/22/zakonczyl-sie-vii-kongres-ordynackiej/'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]uniwersytetradom.pl/art/display_article.php?id=1178'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]uniwersytetradom.pl/art/display_article.php?id=1986'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]www.ptp.org.pl/modules.php?name=News&file=article&sid=25'),  # bot rejected on site (masti, Elfhelm)
    ...
    re.compile('.*[\./@]um\.zabrze\.pl/mieszkancy/miasto/historia/wladze-lokalne'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]radawarszawy\.um\.warszawa\.pl/ewidencje/honorowi/osobywyroznione/Strony/StanislawWyganowski\.aspx'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]europeanvoice\.com/folder/theswedishpresidencyoftheeu/124\.aspx\?artid=65305'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]uniwersytetradom\.pl/art/display_article\.php\?id=1178'),  # bot rejected on site (masti, Elfhelm)
    re.compile('.*[\./@]uniwersytetradom\.pl/art/display_article\.php\?id=1986'),  # bot rejected on site (masti, Elfhelm)
    ...
    re.compile('.*[\./@]radomysl\.pl/asp/pl_start\.asp?typ=14&sub=3&menu=26&strona=1'),  # bot rejected on site (masti, Szoltys)
    re.compile('.*[\./@]radomysl\.pl/asp/pl_start\.asp?typ=14&sub=3&menu=24&strona=1'),  # bot rejected on site (masti, Szoltys)
    ...
    re.compile('.*[\./@]rymanow\.pl/asp/pl_start\.asp?typ=13&sub=0&subsub=0&menu=8&artykul=997&akcja=artykul&schemat=2'),  # bot rejected on site (masti, szoltys)
