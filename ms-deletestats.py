...
class BasicBot(
    ...
    def mainheader(self):
        ...
        header +=u'		<title>Statystyki usunięć - ostatnie ' + self.getOption('days') + u'dni  - tools.wikimedia.pl</title>\n'
        ...
        header +=u'		<h1 id="firstHeading">Statystyki usunięć - ostatnie ' + self.getOption('days') + u' dni</h1>\n'
        header +=u'	</div>\n'
        header +=u'\n'
    ...
    def generateresultspage(self,delete1, delete2):
        ...
        output += self.generatedeletereasonsection(delete1,int(self.getOption('days')))
        output += self.generatedeletestatsection(delete2,int(self.getOption('days')))
